"""Compatibilidad con la versión de consola anterior."""
...
CABECERAS_SCRYFALL = {
    ...
    "User-Agent": "BuscadorCartasMoxfield/1.0",
}
_cache_mas_baratas = {}
...
def Precio_Mas_Barato_Scryfall(nombre):
    ...
    siguiente_url = "https://api.scryfall.com/cards/search"
    siguientes_params = {
...
def Comparar_Precios(carta_moxfield):
    ...
    precio_barato = mas_barata["precio_usd"] if mas_barata else None
    diferencia = None
